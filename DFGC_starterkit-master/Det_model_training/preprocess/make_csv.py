...
if __name__ == '__main__':
    ...
    PICS_ROOT = "E:\//acode\Celeb-DF-v2-crop"   # The dir of cropped training faces
    train_csv = 'E:\//acode\DFGC_starterkit-master\//trainval/dfgc_train.csv'  # the train split file
    val_csv = 'E:\//acode\DFGC_starterkit-master\//trainval/dfgc_val.csv'      # the validation split file
